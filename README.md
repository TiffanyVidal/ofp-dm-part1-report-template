...
- **Free text sections:**: 
  ...
  Simply find the relevant section in the .qmd and type your narrative there.

- **Inside a render_ function (only in `template_part1.qmd`):**
  For results generated by a render_function, edit the `intro_text` = argument 
  inside the code chunk. This text supports markdown formatting and inline references 
  such as {country_name} and cross-references. 
